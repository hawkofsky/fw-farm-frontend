...
import { Text, Progress } from '@hawkofsky/whirlflashx-uikit'
    ...
    <ProgressWrapper>
      ...
      <TopTextWrapper>
        ...
        <Text fontSize="20px" bold color="invertedContrast">
          ...
          {lotteryHasDrawn ? TranslateString(0, 'Ticket sale soon') : TranslateString(0, 'Lottery will be drawed when over 500 tickets are sold')}
        </Text>
      </TopTextWrapper>
      {lotteryHasDrawn && (
        <BottomTextWrapper>
          <Text color="invertedContrast">
            ...
            {TranslateString(0, 'Lottery will be drawed when over 500 tickets are sold')}
          </Text>
        </BottomTextWrapper>
      )}
    </ProgressWrapper>
