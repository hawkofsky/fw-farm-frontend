...
import { Button, IconButton, useModal, AddIcon, Image } from '@hawkofsky/whirlflashx-uikit'
    ...
    <Card isActive={isCardActive} isFinished={isFinished && sousId !== 0}>
      ...
      <div style={{ padding: '24px' }}>
        ...
        <div style={{ marginBottom: '8px', display: 'flex', alignItems: 'center' }}>
          <div style={{ flex: 1 }}>
            <Image src={`/images/tokens/${image || tokenName}-${stakingTokenName}.png`} width={64} height={64} alt={tokenName} />
          </div>
